            ...
            <ul className="flex space-x-8">
              ...
              <li className="relative group">
                ...
                <div className="absolute left-0 mt-2 hidden w-48 rounded-md bg-white p-2 shadow-lg group-hover:block">
                  <Link to="/category/electronics" className="block rounded p-2 hover:bg-gray-100">Electronics</Link>
                  <Link to="/category/clothing" className="block rounded p-2 hover:bg-gray-100">Clothing</Link>
                  <Link to="/category/home" className="block rounded p-2 hover:bg-gray-100">Home & Kitchen</Link>
                  <Link to="/category/beauty" className="block rounded p-2 hover:bg-gray-100">Beauty</Link>
                </div>
              </li>
              <li>
                <Link to="/products" className="text-gray-700 hover:text-blue-700">All Products</Link>
              </li>
              <li>
            ...
            <div className="container mx-auto px-4 py-4">
              ...
              <nav>
                <ul className="space-y-3">
                  <li>
                    <Link to="/" className="block py-2 text-gray-700 hover:text-blue-700">Home</Link>
                  </li>
                  <li>
                    <div className="py-2">
                      <div className="mb-2 font-medium">Categories</div>
                      <div className="ml-4 space-y-2">
                        <Link to="/category/electronics" className="block text-gray-600 hover:text-blue-700">Electronics</Link>
                        <Link to="/category/clothing" className="block text-gray-600 hover:text-blue-700">Clothing</Link>
                        <Link to="/category/home" className="block text-gray-600 hover:text-blue-700">Home & Kitchen</Link>
                        <Link to="/category/beauty" className="block text-gray-600 hover:text-blue-700">Beauty</Link>
                      </div>
                    </div>
                  </li>
                  <li>
                    <Link to="/products" className="block py-2 text-gray-700 hover:text-blue-700">All Products</Link>
                  </li>
                  <li>
                    <Link to="/about" className="block py-2 text-gray-700 hover:text-blue-700">About</Link>
                  </li>
                  <li>
                    <Link to="/contact" className="block py-2 text-gray-700 hover:text-blue-700">Contact</Link>
                  </li>
                </ul>
              </nav>
            </div>
