    ...
    <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      <div className="mb-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
          ...
          <div>
            <label htmlFor="cover_image_url" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            {newCategory.cover_image_url && (
              <div className="mt-2">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t('categories.cover_image_preview')}:</p>
                <img 
